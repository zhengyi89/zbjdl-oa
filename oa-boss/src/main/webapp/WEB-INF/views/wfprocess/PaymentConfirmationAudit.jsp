    ...
    <div id="content_2" class="content_wrapper">
      <div class="content_main">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">回款确认相关信息</div>
            ...
            <form class="cmxform form-horizontal" id="godownForma" name="godownForma" action="${ctx}/wftask/completeTask" method="post">
              ...
              <div class="form-group">
                <div class="col-xs-offset-2 col-xs-3 checkbox">
                  <label>
                    <input type="checkbox" name="fp_isLoanPayment" id="fp_isLoanPayment" checked="checked" value="1" onchange="this.value=(fp_isLoanPayment.checked)?1:0"> 垫资是否回款
                  </label>
                </div>
                <div class="col-xs-1 tip">*</div>
              </div>
              <div class="form-group">
                <label class="col-xs-2 control-label">回款日期</label>
                <div class="col-xs-3">
<!--                   <input type="text" name="fp_loanPaymentTime" id="fp_loanPaymentTime" class="form-control" /> -->
                   <div class="input-group">
									<input id="fp_loanPaymentTime" name="fp_loanPaymentTime" type="text"
              ...
              <div class="col-xs-12 align_center">
                ...
                onclick="$('input[name=fp_appStatus]').val('pass');$('input[name=fp_status]').val('1');$('input[name=fp_approvalStep]').val('16');$('input[name=fp_approvalStatus]').val('0');javascript:submitAudit('godownForma');">提  交</button>
              </div>
            </form>
          </div>
        </div>
...
<jsp:include page="includeWfRemark.jsp"></jsp:include> 
    ...
    /*
      $(function(){
        $("#fp_loanPaymentTime").on("click",function(e){
          e.stopPropagation();
          $(this).easyDatetime({
            css : 'easyDay',
            dateType : 'D',
    ...
    */
      function submitAudit(domId){
    	  ...
    	  /*
    	  var fp_loanPaymentTime = $("#fp_loanPaymentTime").val();
    	  if(fp_loanPaymentTime == null || fp_loanPaymentTime == '' ){
    		  alert("请填写回款日期");
    		  return false;
    	  }
    	 */
