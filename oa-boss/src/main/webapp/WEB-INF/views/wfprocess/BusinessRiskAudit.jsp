    ...
    <div id="content_2" class="content_wrapper">
      <div class="content_main">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">业务确认相关信息</div>
            ...
            <form class="cmxform form-horizontal" id="godownForma" name="godownForma" action="${ctx}/wftask/completeTask" method="post">
              ...
              <div class="form-group">
                <div class="col-xs-offset-2 col-xs-3 checkbox">
                  <label>
                    <input type="checkbox" name="fp_isHouseFreezing" id="fp_isHouseFreezing" checked="checked" value="1" onchange="this.value=(fp_isHouseFreezing.checked)?1:0"> 已确权，业务可做
                  </label>
                </div>
...
<jsp:include page="includeWfRemark.jsp"></jsp:include> 
    ...
    /*
      $(function(){
        $("#fp_houseFreezingTime").on("click",function(e){
          e.stopPropagation();
          $(this).easyDatetime({
            css : 'easyDay',
            dateType : 'D',
    ...
    */
      function submitAudit(domId){
    	  ...
    	  /*
    	  var fp_houseFreezingTime = $("#fp_houseFreezingTime").val();
    	  if(fp_houseFreezingTime == null || fp_houseFreezingTime == '' ){
    		  alert("请填写冻结时间");
    		  return false;
    	  }
    	 */
		...
		$.ajax({
				type : 'POST',
				url : '/ransomfloor-boss/wftask/checkDataValid',
				dataType : "json",
				"async":false,
				data : {id:id},
