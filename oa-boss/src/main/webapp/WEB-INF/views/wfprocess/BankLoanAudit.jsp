    ...
    <div id="content_2" class="content_wrapper">
      <div class="content_main">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">银行放款相关信息</div>
            ...
            <form class="cmxform form-horizontal" id="godownForma" name="godownForma" action="${ctx}/wftask/completeTask" method="post">
              ...
              <div class="form-group">
                <div class="col-xs-offset-2 col-xs-3 checkbox">
                  <label>
                   <input type="checkbox" name="fp_isBankLending" id="fp_isBankLending" checked="checked" value="1" onchange="this.value=(fp_isBankLending.checked)?1:0"> 银行是否放款
                  </label>
                </div>
                <div class="col-xs-1 tip">*</div>
              </div>
              <div class="form-group">
                <label class="col-xs-2 control-label">放款时间</label>
                <div class="col-xs-3">
<!--                   <input type="text" name="fp_bankLendingTime" id="fp_bankLendingTime" class="form-control" /> -->
                  <div class="input-group">
									<input id="fp_bankLendingTime" name="fp_bankLendingTime" type="text"
              ...
              <div class="col-xs-12 align_center">
                ...
                onclick="$('input[name=fp_appStatus]').val('pass');$('input[name=fp_status]').val('1');$('input[name=fp_approvalStep]').val('11');$('input[name=fp_approvalStatus]').val('0');javascript:submitAudit('godownForma');">提  交</button>
              </div>
            </form>
          </div>
        </div>
    ...
    /*
      $(function(){
        $("#fp_bankLendingTime").on("click",function(e){
          e.stopPropagation();
          $(this).easyDatetime({
            css : 'easyDay',
            dateType : 'D',
    ...
    */
      function submitAudit(domId){
    	  ...
    	  /*
    	  var fp_bankLendingTime = $("#fp_bankLendingTime").val();
    	  if(fp_bankLendingTime == null || fp_bankLendingTime == '' ){
    		  alert("请填写放款时间");
    		  return false;
    	  }
    	 */
