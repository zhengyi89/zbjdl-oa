		...
		<div class="content_main">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form action="${pageContext.request.contextPath}/notice/noticeadminIndex" method="get" id="godownForma" name="godownForma"
					...
					<div class="col-lg-12">
						...
						<q:table queryService="queryService" queryKey="queryNotice"
							...
							<q:column title="操作" escapeHtml="false">
								...
								<span>&nbsp;&nbsp;</span>
								<a class="margr4" href="${pageContext.request.contextPath}/notice/toNoticeEdit?id=${id}">
									编辑
								</a>
							</q:column>
							</q:table>
