		...
		<div class="content_main clearfix">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form action="${pageContext.request.contextPath}/report/fundSummary" method="get" id="godownForma" name="godownForma"
						class="cmxform form-horizontal">
						 <div class="form-group">
							...
							<label for="customerType" class="col-lg-1 control-label">贷款总行</label>
							<div class="col-lg-2">
								<select class="form-control" id="nowLoanBank" name="nowLoanBank">
									<option value="" class='select active'></option>
									<script type="text/javascript">
										BusinessCode.getSysConfigCode("NOWLOANBANK", "nowLoanBank", "$!{query.nowLoanBank}");
									</script>
								 </select>
							</div>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<!-- 结果列表 -->
					<div class="col-lg-12">
						<q:table queryService="queryService" queryKey="queryFundSummary"
							...
							<q:column title="总行名称" value="${_textResource.getSysText('NOWLOANBANK', nowloanbank)}" dataIndex="nowloanbank" />
							<q:column title="支行名称" value="${_textResource.getSysText('NOWLOANBRANCHBANK', nowloanbranchbank)}" dataIndex="nowloanbranchbank" />
							<q:column title="笔数" value="${counts}" dataIndex="counts" />
							<q:column title="解押金合计" value="${solutionamountcount}" dataIndex="solutionamountcount" />
