		...
		<div class="content_main clearfix">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form action="${pageContext.request.contextPath}/report/performanceSummary" method="get" id="godownForma" name="godownForma"
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<!-- 结果列表 -->
					<div class="col-lg-12">
						<q:table queryService="queryService" queryKey="queryPerformanceSummary"
							...
							<q:column title="现金业绩" value="${xianjincounts}" dataIndex="xianjincounts" />
							<q:column title="保函业绩" value="${danbaocounts}" dataIndex="danbaocounts" />
							<q:column title="待办业绩" value="${daibancounts}" dataIndex="daibancounts" />
							<q:column title="现金解押" value="${xianjinamount}" dataIndex="xianjinamount" />
							<q:column title="保函解押" value="${danbaoamount}" dataIndex="danbaoamount" />
							<q:column title="贷款额" value="${daibanamount}" dataIndex="daibanamount" />
						</q:table>
					</div>
				</div>
			</div>
