		...
		<div class="content_main clearfix">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form action="${pageContext.request.contextPath}/report/portfolio" method="get" id="godownForma" name="godownForma"
						class="cmxform form-horizontal">
						 <div class="form-group">
							...
							<label for="customerType" class="col-lg-1 control-label">业务员姓名</label>
							<div class="col-lg-2">
								<input type="text" id="receiveName" name="receiveName" class="form-control" placeholder="" />
							</div>
							<label for="customerType" class="col-lg-1 control-label">业务员手机号</label>
							<div class="col-lg-2">
				...
				<div class="panel-body">
					...
					<div class="col-lg-12">
						<q:table queryService="queryService" queryKey="querySmsInfo"
							...
							<q:column title="业务员编号" value="${serialno}" dataIndex="serialno" />
							<q:column title="业务员姓名" value="${sendtime}" dataIndex="sendtime" />
							<q:column title="成功笔数" value="${receivename}" dataIndex="receivename" />
							<q:column title="处理中笔数" value="${receivemobile}" dataIndex="receivemobile" />
							<q:column title="业务驳回笔数" value="${bizno}" dataIndex="bizno" />
							<q:column title="风控驳回笔数" value="${smsstate}" dataIndex="smsstate" />
							<q:column title="45天过期笔数" value="${oriserialno}" dataIndex="oriserialno" />
					</q:table>
