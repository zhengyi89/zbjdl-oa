    ...
    <div id="content_2" class="content_wrapper">
      <div class="content_main">
        <div class="panel panel-default">
          <div class="panel-heading">业务备注</div>
          <div class="panel-body">
            <form class="cmxform form-horizontal" action="${ctx}/wftask/wfTaskRemarkInfoIndex" method="get" id="godownForma"
				  name="godownForma">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="col-xs-12">
            <q:table queryService="queryService" queryKey="queryRemarkTaskInfo" formId="godownForma"
				...
				<q:column title="解押金额" value="${_messageFormater.formatNumber(sellersolutionamount)}" width="11%"/>
				<q:column title="待办角色" value="${status != '2' ? groupname : ''}" width="10%"/>
				<q:column title="待办节点" escapeHtml="false" value="${_textResource.getSysText('TASK_APPROVE_STEP', taskname)}" width="10%"/>
				<q:column title="创建时间" width="9%" >
					<fmt:formatDate value="${createtime}" pattern="yyyy-MM-dd HH:mm:ss" />
				</q:column>
				<q:column title="操作" escapeHtml="false" width="6%">
					<a class="margr4" href="${ctx}/wftask/wfRemarkIndex?id=${id}">备注</a>
				</q:column>
			</q:table>				
            </div>
          </div>
