(function($){
	 ...
	 */
	$.fn.mNumber=function(){
		var _this = $(this).css("ime-mode" , "disabled").keydown(function(e){
			var str = _this.val()||"";
			var len = str.length;
			var pos = str.indexOf(".");
			var unicodechar = e.which;
			if(unicodechar==8||(unicodechar<106&&unicodechar>95)||(unicodechar<58&&unicodechar>47)||unicodechar==110||unicodechar==190){
				if(pos!=-1&&len>pos+2&&unicodechar!=8){
					e.preventDefault();
				}else{
					return true;
				}
