(function ($) {
    ...
    function Scroller(elem, settings) {
        ...
        function generateWheelItems(i) {
            ...
            for (j in warr[i]) {
                ...
                html += '<div class="dw-li dw-v" data-val="' + j + '" style="height:' + hi + 'rem;line-height:' + hi + 'rem;"><div class="dw-i">' + warr[i][j] + '</div></div>';
                l++;
            }
            html += '</div>';
            return html;
            ...
            if (event('validate', [dw, index, time]) !== false) {
                ...
                $('.dw-ul', dw).each(function (i) {
                    ...
                    if (!(cell.hasClass('dw-sel')) || sc) {
                        ...
                        that.scroll(t, i, v, sc ? time : 0.3, sc ? orig : undefined);
                    }
                });
        ...
        */
        that.scroll = function (t, index, val, time, orig) {
            ...
            t.attr('style', (prefix + '-transition:all ' + (time ? time.toFixed(3) : 0) + 's ease-out;') + (has3d ? (prefix + '-transform:translate3d(0,' + px + 'rem,0);') : ('top:' + px + 'rem;')));
        ...
        */
        that.show = function (prevAnim) {
            ...
            var html = '<div class="dw-trans ' + s.theme + ' dw-' + s.display + '">' + (s.display == 'inline' ? '<div class="dw dwbg dwi"><div class="dwwr">' : '<div class="dw-persp">' + '<div class="dwo"></div><div class="dw dwbg ' + mAnim + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr">' + (s.headerText ? '' : ''));
            ...
            for (i = 0; i < s.wheels.length; i++) {
                ...
                for (label in s.wheels[i]) {
                    ...
                    html += '<td><div class="dwwl dwrc dwwl' + l + '">' + (s.mode != 'scroller' ? '<div class="dwwb dwwbp" style="height:' + hi + 'rem;line-height:' + hi + 'rem;"><span>+</span></div><div class="dwwb dwwbm" style="height:' + hi + 'rem;line-height:' + hi + 'rem;"><span>&ndash;</span></div>' : '') + '<div class="dwl">' + label + '</div><div class="dww" style="height:' + (s.rows * hi) + 'rem;min-width:' + s.width + 'rem;"><div class="dw-ul">';
                    // Create wheel values
            ...
            html += (s.display != 'inline' ? '<div class="dwbc' + (s.button3 ? ' dwbc-p' : '') + '"><span class="dwbw dwb-s"><span class="dwb" style="color: #00d9b3;background-color: #effbfa;">' + s.setText + '</span></span>' + (s.button3 ? '<span class="dwbw dwb-n"></span>' : '') + '<span class="dwbw dwb-c"><span class="dwb" >' + s.cancelText + '</span></span></div></div>' : '<div class="dwcc"></div>') + '</div></div></div>';
            dw = $(html);
        ...
        */
        that.init = function (ss) {
            ...
            extend(s, theme.defaults, settings);
    ...
    function calc(t, val, dir, anim, orig) {
        ...
        var cell = $('.dw-li', t).eq(val),
            ...
            idx = index,
            time = anim ? (val == o ? 0.3 : Math.abs((val - o) * 0.3)) : 0;
