...
<body>
	<div class="topbar">
		<a class="return" href="javascript:window.history.go(-1);"></a> 我要买房 <a
			class="submit" onclick="javascript:check();">提交</a>
	</div>
	<form action="${ctx}/bussDemand/save" id="form1" method="get">
		<div class="showbox">
			<div class="submit_input">
				...
				<p>
					<input type="text" placeholder="请填写您理想中的买方地址信息" name="address" />
				</p>
				<p class="last">
					<input type="text" placeholder="预算" name="amount" />
				</p>
			</div>
