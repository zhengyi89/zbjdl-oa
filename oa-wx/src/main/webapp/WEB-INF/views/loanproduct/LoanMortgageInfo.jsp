...
<body>
	...
	<div class="weui_msg">
		<div class="mine_icon_area">
			<img src="${def}/images/finance_house_loan.png" />
		</div>
		<div class="weui_text_area">
			<h2 class="weui_msg_title">个人房屋按揭贷款</h2>
			<p class="weui_msg_desc">
				客户购买住房时，支付规定比例首付款后<br /> 在提供我行认可担保前提下<br />
				其余购房款由我行贷款支付，并按约定方式还本付息
			</p>
		</div>
	</div>
	<div class="weui_panel weui_panel_access">
		...
		<div class="weui_panel_bd">
			<div class="weui_media_box weui_media_text">
				<h4 class="weui_media_title">额度高</h4>
				<p class="weui_media_desc">购买首套住房，当前最高可获得房产价值80%贷款额度</p>
			</div>
			<div class="weui_media_box weui_media_text">
				<h4 class="weui_media_title">期限长</h4>
				<p class="weui_media_desc">住房按揭贷款期限最长30年</p>
			</div>
			<div class="weui_media_box weui_media_text">
				<h4 class="weui_media_title">成本低</h4>
				<p class="weui_media_desc">首套房按揭贷优惠至基准利率九折</p>
			</div>
			<div class="weui_media_box weui_media_text">
				<h4 class="weui_media_title">配套优惠</h4>
				<p class="weui_media_desc">可配套办理所购小区住房一手车位按揭贷款</p>
			</div>
		</div>
	</div>
	<div class="weui_msg">
	...
	<script type="text/javascript">
        ...
        var shareData = {
            title: '民生按揭贷',
            desc: '额度高、周期长、费率低',
            link: path+path_sub+"/product/productInfoIndex?type=mortgage&merchant="+merchant,
            imgUrl: path+'${def}/images/house_loan.png'
        };
