...
<body>
	<div class="topbar">
		<a class="return" onclick="history.go(-1)"></a> 过户、抵押
	</div>
	<div class="showbox">
		<form class="cmxform form-horizontal" id="godownForma"
			...
			<div class="submit_input">
				...
				<input id="taskId" name="taskId" type="hidden" value="${wfTask.wfTaskInfo.id }"/>
              	...
              	<input name="fp_isTransferHouse" id="fp_isTransferHouse" value="1" type="hidden" />
				<p class="selectRadio ed" name="fp_isTransferHouse1" id="fp_isTransferHouse1" selected="selected"
					onclick="toggleRadio(this);">是否已过户*</p>

				<p class="last">
					<input type="text" name="fp_transferHouseTime" id="fp_transferHouseTime" placeholder="请选择过户时间" />
				</p>
			</div>
			...
			<div class="submit_box">
				<p class="submit">
					<input type="button" value="提  交"
						onclick="$('input[name=fp_appStatus]').val('pass');$('input[name=fp_status]').val('1');$('input[name=fp_approvalStep]').val('15');$('input[name=fp_approvalStatus]').val('0');javascript:submitAudit('godownForma');">
				</p>
			</div>
    ...
    function toggleRadio(obj) {
		if ($(obj).hasClass("ed")) {
			$("#fp_isTransferHouse").val("0");
			$(obj).removeClass("ed");
			$(obj).removeAttr("selected");
		} else {
			$("#fp_isTransferHouse").val("1");
			$(obj).addClass("ed");
	...
	<script type="text/javascript">
	    $(function () {
	        ...
	        $("#fp_transferHouseTime").mobiscroll($.extend(opt['date'], opt['default']));
