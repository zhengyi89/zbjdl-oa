...
<body>
	<div class="topbar">
		<a class="return" onclick="history.go(-1)"></a> 保函出具确认
	</div>
	<div class="showbox">
		<form class="cmxform form-horizontal" id="godownForma"
			...
			<div class="submit_input">
				<input id="taskId" name="taskId" type="hidden" value="${wfTask.wfTaskInfo.id }"/>
             	...
             	<input name="fp_isIssueGuarantee" id="fp_isIssueGuarantee" value="1" type="hidden" />
				<p class="selectRadio ed" name="fp_isIssueGuarantee1" id="fp_isIssueGuarantee1" selected="selected" onclick="toggleRadio(this);">是否出具保函*</p>

				<p class="last">
					<input type="text" name="fp_issueGuaranteeTime" id="fp_issueGuaranteeTime" placeholder="请选择出具时间" />
				</p>
			...
			<div class="submit_box">
				<p class="submit">
					<input type="button" value="提  交"
						onclick="$('input[name=fp_appStatus]').val('pass');$('input[name=fp_status]').val('1');$('input[name=fp_approvalStep]').val('10');$('input[name=fp_approvalStatus]').val('0');javascript:submitAudit('godownForma');">
				</p>
			</div>
	...
	<script type="text/javascript">
	    function toggleRadio(obj) {
			if ($(obj).hasClass("ed")) {
				$("#fp_isIssueGuarantee").val("0");
				$(obj).removeClass("ed");
				$(obj).removeAttr("selected");
			} else {
				$("#fp_isIssueGuarantee").val("1");
				$(obj).addClass("ed");
	    ...
	    function submitAudit(domId){
	    	  ...
	    	  if(fp_isIssueGuarantee == null || fp_isIssueGuarantee == '' || fp_isIssueGuarantee == '0'){
	    		  alert("请勾选是否出具保函   ");
	    		  return false;
	    	  }
	...
	<script type="text/javascript">
	    $(function () {
	        ...
	        $("#fp_issueGuaranteeTime").mobiscroll($.extend(opt['date'], opt['default']));
