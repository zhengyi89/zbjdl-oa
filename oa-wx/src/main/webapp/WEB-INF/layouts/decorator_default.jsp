...
<head>
    ...
    <script type="text/javascript" src="${def}/js/zepto.min.js?version=brd0004"></script>
...
<div id="alertMsg" style="display:none">
     <div class="alertBox">
       <p id="msg"></p>
       <input type="button" name="name" value="确     定" onclick="document.getElementById('alertMsg').style.display='none';"/>
     </div>
   </div>
</body>
</html>